...
5. Test the protocol with cable disconnections and noise
	...
	5.2. Quickly move to the cable program console and press 0 to unplug the cable, 2 to add noise, and 1 to normal
	5.3. Check if the file received matches the file sent, even with cable disconnections or noise
